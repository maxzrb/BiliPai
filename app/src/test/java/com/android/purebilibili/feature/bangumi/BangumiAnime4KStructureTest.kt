...
class BangumiAnime4KStructureTest {
    ...
    fun `bangumi player routes video through Anime4K pipeline`() {
        ...
        assertTrue(playerSource.contains("resolveVideoContentViewportLayout("))
        assertTrue(playerSource.contains("width = anime4kViewport.width.toDp()"))
        assertTrue(playerSource.contains("height = anime4kViewport.height.toDp()"))
